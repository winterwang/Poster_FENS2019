...
\begin{itemize}
	...
	\item Time of the day was categorized into 7 slots: 6-9 am, 9-12 noon, 12-2 pm, 2-5 pm, 5-8 pm, 8-10 pm and 10 pm-6 am; foods recorded were categorised in one of 60 standard food groups.\vskip-0.65ex
...
No diabetes              & No                     & $<$ 6.10                 & AND  & $<$ 6.5          & 2626          \\
Pre-diabetes             & No                     & 6.10 $\sim$ 6.99         &   & --              &   133        \\
Undiagnosed              & No                     & $\geqslant$ 7.00        & OR   & $\geqslant$ 6.5  &   99        \\
Diagnosed                & Yes                    & --                      &   & --                &   227       \\ 
...
\begin{itemize}
	...
	\item The odds ratio estimate was derived of consuming unhealthy food groups selected by CA, later in the day (8pm - 6am) compared to earlier in the day, by logistic regression models with generalised estimating equation (GEE) accounting for repeated food entries from the same individual.
...
\vskip-2.45ex
    \begin{figure}
      \centering
      \caption{Biplot for CA of food groups and time slots among \underline{\textbf{non-diabetics}}.}
...
\begin{figure}
      \centering
      \caption{Biplot for CA of food groups and time slots among \underline{\textbf{diabetics}}.}
...
\begin{column}{\colwidth}
  \begin{block}{}
    ...
    \begin{figure}
      \centering
      \caption{Biplot for CA of food groups and time slots among \underline{\textbf{undiagnosed diabetics}}.}
      \includegraphics[width=0.88\textwidth]{Fig/F60T7_UndiagDM.png}	\vskip-2.45ex
      \label{fig:UndiagDM}
    \end{figure}
    \begin{figure}
      \centering
      \caption{Biplot for CA of food groups and time slots among \underline{\textbf{pre-diabetics}}.}
...
% \usepackage{booktabs}
\begin{table}
\caption{\label{tab:tab2}OR (99\%CI) for food groups eaten at night (8pm - 6am) vs. earlier time, among total and according to different T2D status, NDNS RP 2008-2017.}
\small
\vskip-1.85ex
\begin{tabular}{@{}lccccc@{}}
\toprule
