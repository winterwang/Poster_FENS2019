...
\begin{itemize}
	...
	\item The odds ratio estimate was derived of consuming the unhealthy food groups (the ones flagged by CA) later in the day compared to earlier in the day, by logistic regression models with generalised estimating equation (GEE) accounting for repeated measures (food entries) from the same individual.
